function startgame() {
    (document.getElementById("shop").style.display = "block"), (document.getElementById("store1").style.display = "block"), (document.getElementById("show").style.display = "none"), setInterval(idle, 1);
}
function loadshop() {
    (document.getElementById("shop").style.display = "block"), (document.getElementById("show").style.display = "none");
}
setInterval(changeCoinImage, 1e3),
    setInterval(checkAchievements, 1e3),
    setInterval(getSelected, 1e3),
    setInterval(poplitSelectList, 1e3),
    setInterval(wallpaper, 1e3),
    ...
    document.addEventListener("DOMContentLoaded", function () {
        document.getElementById("poplitSelectStyle").addEventListener("change", getSelected);
    }),
    document.addEventListener("DOMContentLoaded", function () {
        document.getElementById("backSelectStyle").addEventListener("change", getSelected);
    });
var time = 36e5;
setInterval(function () {
    (allow += 1), console.log("allow is now ${allow}");
}, time);
var insurance,
    txt,
    text,
    ...
    poplits = {
        ...
        blueberry: { level: ["VI"] },
        grape: { level: ["VII"] },
        pomegranate: { level: ["VIII"] },
        maple: { level: ["IX"] },
        mango: { level: ["X"] },
        tea: { level: ["XI"] },
        coconut: { level: ["XII"] },
        peppermint: { level: ["XIII"] },
        dragonfruit: { level: ["XIV"] },
    };
const suffixes = [
    "",
    "K",
...
function hideshop() {
    (document.getElementById("shop").style.display = "none"), (document.getElementById("show").style.display = "flex");
}
function showAdd() {
    if (allow > 0) {
        const n = [ad1, ad2, ad3];
        (0, n[Math.floor(Math.random() * n.length)])(),
            (purch += 1),
            (allow -= 1),
    ...
    } else alert("You are out of ad tokens, get more by redeeming them through codes, or waiting 24 hours and you will get one.");
}
function ad1() {
    (document.getElementById("game").style.display = "none"), (document.getElementById("ad1").style.display = "block"), (document.getElementById("timeleft1").style.display = "flex");
    let n = 29,
        i = setInterval(function () {
            if (n <= 0) clearInterval(i), (document.getElementById("exe1").style.display = "flex"), (document.getElementById("timeleft1").style.display = "none"), (timeleft1.innerHTML = "30s");
            else {
                let i = Math.floor(n);
                (timeleft1.innerHTML = " " + i + "s"), (n -= 1);
            }
        }, 1e3);
}
function ad2() {
    (document.getElementById("game").style.display = "none"), (document.getElementById("ad2").style.display = "block"), (document.getElementById("timeleft2").style.display = "flex");
    let n = 29,
        i = setInterval(function () {
            if (n <= 0) clearInterval(i), (document.getElementById("exe2").style.display = "flex"), (document.getElementById("timeleft2").style.display = "none"), (timeleft2.innerHTML = "30s");
            else {
                let i = Math.floor(n);
                (timeleft2.innerHTML = " " + i + "s"), (n -= 1);
            }
        }, 1e3);
}
function ad3() {
    (document.getElementById("game").style.display = "none"), (document.getElementById("ad3").style.display = "block"), (document.getElementById("timeleft3").style.display = "flex");
    let n = 29,
        i = setInterval(function () {
            if (n <= 0) clearInterval(i), (document.getElementById("exe3").style.display = "flex"), (document.getElementById("timeleft3").style.display = "none"), (timeleft3.innerHTML = "30s");
            else {
                let i = Math.floor(n);
                (timeleft3.innerHTML = " " + i + "s"), (n -= 1);
            }
        }, 1e3);
}
function exe() {
...
function timer() {
    const n = new Date("October 31, 2023 00:00:00").getTime() - new Date().getTime(),
        i = Math.floor(n / 864e5),
        e = Math.floor((n % 864e5) / 36e5),
        t = Math.floor((n % 36e5) / 6e4),
        l = Math.floor((n % 6e4) / 1e3);
    document.getElementById("shoptime").innerHTML = `(Ends In: ${i}:${e}:${t}:${l})`;
}
function format() {
    if (count < 1e3) {
        let n = Math.round(count);
        (printerName.innerHTML = "You have $" + n), (document.title = n + " Cats - Catstack");
    } else {
        let n = Math.floor(Math.log10(count) / 3),
            i = suffixes[n],
            e = count / Math.pow(10, 3 * n);
        (e = e >= 10 ? Math.floor(e) : e.toFixed(1)), (printerName.innerHTML = "You have $" + e + i), (document.title = e + i + " Cats - Catstack");
    }
}
function update() {
    (goldtext.innerHTML = goldencats),
        ...
        farmercats > 0 && ((document.getElementById("store2").style.display = "block"), (document.getElementById("store3").style.display = "block")),
        (farmercat.innerHTML = " Farmer Cats (" + farmercats + ")"),
        minercats > 0 && ((document.getElementById("store3").style.display = "block"), (document.getElementById("store4").style.display = "block")),
        (minercat.innerHTML = " Miner Cats (" + minercats + ")"),
        workercats > 0 && ((document.getElementById("store4").style.display = "block"), (document.getElementById("store5").style.display = "block")),
        (workercat.innerHTML = " Worker Cats (" + workercats + ")"),
        bankercats > 0 && ((document.getElementById("store5").style.display = "block"), (document.getElementById("store6").style.display = "block")),
        (bankercat.innerHTML = " Banker Cats (" + bankercats + ")"),
        alchemistcats > 0 && ((document.getElementById("store6").style.display = "block"), (document.getElementById("store6").style.display = "block")),
...
function idle(n = 1) {
    (count += normalIns),
        ...
        (count += mutiIns),
        (count += spawnIns);
    let i = (count += cloneIns);
    for (let n = suffixes.length - 1; n >= 1; n--) {
        const e = Math.pow(10, 3 * n);
        if (count >= e) {
            i = (count / e).toFixed(1) + suffixes[n];
            break;
        }
    }
    (printerName.innerHTML = "You have $" + i), format();
}
function normalcatbuy() {
    if (count >= cost1) {
        (count -= cost1),
            (normalIns += addnormalIns),
            (normalcats += 1),
            (cost1 = Math.round(1.2 * cost1)),
            console.log(cost1),
            (document.getElementById("store2").style.display = "block"),
            (normalcat.innerHTML = " Cats (" + normalcats + ")");
        let n = count;
        for (let i = suffixes.length - 1; i >= 1; i--) {
            const e = Math.pow(10, 3 * i);
            if (count >= e) {
                n = (count / e).toFixed(1) + suffixes[i];
                break;
            }
        }
        let i = cost1;
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (cost1 >= e) {
                i = (cost1 / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (rack.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack"), format();
    }
}
function farmercatbuy() {
    if (count >= cost2) {
        (count -= cost2),
            (farmerIns += addfarmerIns),
            (farmercats += 1),
            (cost2 = Math.round(1.2 * cost2)),
            console.log(cost2),
        ...
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (cost2 >= e) {
                i = (cost2 / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (rackTwo.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack"), format();
    }
}
function minercatbuy() {
    if (count >= cost3) {
        (count -= cost3),
            (minerIns += addminerIns),
            (minercats += 1),
            (cost3 = Math.round(1.2 * cost3)),
            console.log(cost3),
        ...
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (cost3 >= e) {
                i = (cost3 / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (rackThree.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack"), format();
    }
}
function workercatbuy() {
    if (count >= cost4) {
        (count -= cost4),
            (workerIns += addworkerIns),
            (workercats += 1),
            (cost4 = Math.round(1.2 * cost4)),
            console.log(cost4),
        ...
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (cost4 >= e) {
                i = (cost4 / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (rackFour.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack"), format();
    }
}
function bankercatbuy() {
    if (count >= cost5) {
        (count -= cost5),
            (bankerIns += addbankerIns),
            (bankercats += 1),
            (cost5 = Math.round(1.2 * cost5)),
            console.log(cost5),
        ...
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (cost5 >= e) {
                i = (cost5 / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (rackFive.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack"), format();
    }
}
function alchemistcatbuy() {
    if (count >= cost6) {
        (count -= cost6),
            (alchemistIns += addalchemistIns),
            (alchemistcats += 1),
            (cost6 = Math.round(1.2 * cost6)),
            console.log(cost6),
        ...
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (cost6 >= e) {
                i = (cost6 / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (rackSix.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack"), format();
    }
}
function dev() {
    count *= cost1;
...
function checkScreenSize() {
    ...
    n > 5010
        ? ((document.getElementById("game").style.display = "none"), (document.getElementById("sizeCom").style.display = "block"), (document.getElementById("sizeCom").style.color = "red"), (size.innerHTML = n + "px "))
        : (document.getElementById("sizeCom").style.display = "none");
}
function resetGame() {
    "yes" === prompt("Are you sure you want to reset the game? Type 'yes' to confirm.").toLowerCase()
        ? ((num = 1),
          (goldencats = 0),
          (allow = 1),
          (count = 0),
...
(window.onload = function () {
    const n = JSON.parse(localStorage.getItem("savedData"));
    n &&
        ((num = n.num || 1),
        (allow = n.allow || 0),
        (count = n.count || 0),
        (clicks = n.clicks || 0),
        (numbers = n.numbers || 150),
        (normalIns = n.normalIns || 0),
        (farmerIns = n.farmerIns || 0),
        (minerIns = n.minerIns || 0),
        (workerIns = n.workerIns || 0),
        (bankerIns = n.bankerIns || 0),
        (alchemistIns = n.alchemistIns || 0),
        (astronautIns = n.astronautIns || 0),
        (priestIns = n.priestIns || 0),
        (mageIns = n.mageIns || 0),
        (gatekeeperIns = n.gatekeeperIns || 0),
        (antiIns = n.antiIns || 0),
        (luckyIns = n.luckyIns || 0),
        (illusionistIns = n.illusionistIns || 0),
        (coderIns = n.coderIns || 0),
        (mutiIns = n.mutiIns || 0),
        (spawnIns = n.spawnIns || 0),
        (cloneIns = n.cloneIns || 0),
        (goldencats = n.goldencats || 0),
        (normalcats = n.normalcats || 0),
        (farmercats = n.farmercats || 0),
        (workercats = n.workercats || 0),
        (bankercats = n.bankercats || 0),
        (minercats = n.minercats || 0),
        (alchemistcats = n.alchemistcats || 0),
        (astronautcats = n.astronautcats || 0),
        (catpriest = n.catpriest || 0),
        (catmage = n.catmage || 0),
        (gatekeepercats = n.gatekeepercats || 0),
        (anticats = n.anticats || 0),
        (luckycats = n.luckycats || 0),
        (catillusionist = n.catillusionist || 0),
        (catcoders = n.catcoders || 0),
        (catmultitaskers = n.catmultitaskers || 0),
        (catspawn = n.catspawn || 0),
        (clone = n.clone || 0),
        (cost1 = n.cost1 || 15),
        (cost2 = n.cost2 || 100),
        (cost3 = n.cost3 || 1e3),
        ...
        (cost8 = n.cost8 || 1e15),
        (cost9 = n.cost9 || 1e18),
        (cost10 = n.cost10 || 1e21),
        (cost11 = n.cost11 || 1e24),
        (cost12 = n.cost12 || 1e27),
        (cost13 = n.cost13 || 1e30),
        (cost14 = n.cost14 || 1e33),
        (cost15 = n.cost15 || 1e36),
        (cost16 = n.cost16 || 1e39),
        (cost17 = n.cost17 || 1e42),
        (usedSophie = n.usedSophie || !1),
        (usedDev = n.usedDev || !1),
        (heros = n.heros || 0));
}),
    setInterval(function () {
        ...
        localStorage.setItem("savedData", JSON.stringify(n));
    }, 1e3);
let clickEarned = !1,
    doubleClickEarned = !1,
    clickTrainingEarned = !1,
    clickathlonEarned = !1,
    clickolympicsEarned = !1,
    clicktasticEarned = !1,
    clickoramaEarned = !1,
    clickmadicEarned = !1,
    clickopathEarned = !1,
    clicktastropheEarned = !1,
    clickoutbreakEarned = !1,
    clickidemicEarned = !1,
    clickpocalypse = !1,
    totalAch = 0;
function checkAchievements() {
    clicks >= 1 && !clickEarned
        ? (console.log("Make One Kit Coin from clicking"), (clickEarned = !0), (totalAch += 1))
        : clicks >= 100 && !doubleClickEarned
        ? (console.log("Make 100 Kit Coins from clicking"), (doubleClickEarned = !0), (totalAch += 1))
        : clicks >= 1e3 && !clickTrainingEarned
        ? (console.log("Make a Thousand Kit Coins from clicking"), (clickTrainingEarned = !0), (totalAch += 1))
        : clicks >= 1e6 && !clickathlonEarned
        ? (console.log("Make a Million Kit Coins from clicking"), (clickathlonEarned = !0), (totalAch += 1))
        : clicks >= 1e9 && !clickolympicsEarned
        ? (console.log("Make a Billion Kit Coins from clicking"), (clickolympicsEarned = !0), (totalAch += 1))
        : clicks >= 1e12 && !clicktasticEarned
        ? (console.log("Make a Tillion Kit Coins from clicking"), (clicktasticEarned = !0), (totalAch += 1))
        : clicks >= 1e15 && !clickoramaEarned
        ? (console.log("Make a Quadrillion Kit Coins from clicking"), (clickoramaEarned = !0), (totalAch += 1))
        : ((clicks >= 1e18 && !clickmadicEarned) || (clicks >= 1e21 && !clickmadicEarned) || (clicks >= 1e24 && !clickmadicEarned)) && (console.log("Make a Quintillion Kit Coins from clicking"), (clickmadicEarned = !0), (totalAch += 1));
}
let poplitLevel = "normal",
    earnedLevel = "normal";
function changeCoinImage() {
    let n = document.getElementById("coin"),
        i = "",
        e = document.getElementById("poplitSelectStyle"),
        t = e.options[e.selectedIndex].text.toLowerCase();
    switch (
        ("automatic" === t
            ? (totalAch >= 2 && "normal" === earnedLevel && (earnedLevel = "raspberry"),
              totalAch >= 4 && "raspberry" === earnedLevel && (earnedLevel = "orange"),
              count >= 1e3 && "orange" === earnedLevel && (earnedLevel = "banana"),
              count >= 1e4 && "banana" === earnedLevel && (earnedLevel = "lime"),
              count >= 1e6 && "lime" === earnedLevel && (earnedLevel = "blueberry"),
              count >= 1e9 && "blueberry" === earnedLevel && (earnedLevel = "grape"),
              count >= 1e12 && "grape" === earnedLevel && (earnedLevel = "pomegranate"),
              count >= 1e15 && "pomegranate" === earnedLevel && (earnedLevel = "maple"),
              count >= 1e18 && "maple" === earnedLevel && (earnedLevel = "mango"),
        ...
        case "normal":
            i = "css/media/poplits/normalCoin.png";
            break;
        case "raspberry":
            i = "css/media/poplits/redCoin.png";
            break;
        case "orange":
            i = "css/media/poplits/orangeCoin.png";
            break;
        case "banana":
            i = "css/media/poplits/bananaCoin.png";
            break;
        case "lime":
            i = "css/media/poplits/limeCoin.png";
            break;
        case "blueberry":
            i = "css/media/poplits/blueberryCoin.png";
            break;
        case "grape":
            i = "css/media/poplits/grapeCoin.png";
            break;
        case "pomegranate":
            i = "css/media/poplits/pomegranateCoin.png";
            break;
        case "maple":
            i = "css/media/poplits/mapleCoin.png";
            break;
        case "mango":
            i = "css/media/poplits/mangoCoin.png";
            break;
        case "tea":
            i = "css/media/poplits/teaCoin.png";
            break;
        case "coconut":
            i = "css/media/poplits/coconutCoin.png";
            break;
        case "peppermint":
            i = "css/media/poplits/peppermintCoin.png";
            break;
        case "dragonfruit":
            i = "css/media/poplits/dragonfruitCoin.png";
            break;
        case "golden":
            i = "css/media/poplits/goldCoin.png";
            break;
        case "prism":
            i = "css/media/poplits/prismCoin.png";
            break;
        case "queen":
            i = "css/media/poplits/pinkCoin.png";
            break;
        case "kill":
            i = "css/media/poplits/knightCoin.png";
    }
    let l = "<img src='" + i + "' class='coin-image'>";
    n.innerHTML = l;
}
function poplitSelectList() {
    let n = "normal";
    return (
        totalAch >= 2 && "normal" === n && ((n = "raspberry"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[2].disabled = !1)),
        totalAch >= 4 && "raspberry" === n && ((n = "orange"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[3].disabled = !1)),
        count >= 1e3 && "orange" === n && ((n = "banana"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[4].disabled = !1)),
        count >= 1e4 && "banana" === n && ((n = "lime"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[5].disabled = !1)),
        count >= 1e6 && "lime" === n && ((n = "blueberry"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[6].disabled = !1)),
        count >= 1e9 && "blueberry" === n && ((n = "grape"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[7].disabled = !1)),
        count >= 1e12 && "grape" === n && ((n = "pomegranate"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[8].disabled = !1)),
        count >= 1e15 && "pomegranate" === n && ((n = "maple"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[9].disabled = !1)),
        count >= 1e18 && "maple" === n && ((n = "mango"), (document.getElementById("poplitSelectStyle").getElementsByTagName("option")[10].disabled = !1)),
        n
    );
}
function wallpaper() {
    let n = document.getElementById("backSelectStyle"),
        i = n.options[n.selectedIndex].text.toLowerCase(),
        e = "";
    if ("default" === i);
    else {
        switch (i) {
            case "default":
                e = "css/media/backgrounds/defBack.jpeg";
                break;
            case "red":
                e = "css/media/backgrounds/redBack.jpeg";
                break;
            case "orange":
                e = "css/media/backgrounds/orangeBack.jpeg";
                break;
            case "yellow":
                e = "css/media/backgrounds/yellowBack.jpeg";
                break;
            case "lime":
                e = "css/media/backgrounds/limeBack.jpeg";
                break;
            case "blue":
                e = "css/media/backgrounds/blueBack.jpeg";
                break;
            case "purple":
                e = "css/media/backgrounds/purpleBack.jpeg";
                break;
            case "pink":
                e = "css/media/backgrounds/pinkBack.jpeg";
                break;
            case "prism":
            case "kill":
                e = "css/media/backgrounds/prismBack.jpeg";
        }
        document.getElementById("game").style.backgroundImage = "url('" + e + "')";
    }
}
function buyClickPower() {
    if (count >= clickCost) {
        (count -= clickCost), (clickCost = Math.round(80.5 * clickCost)), (num *= 2), console.log(clickCost);
        let n = count;
        for (let i = suffixes.length - 1; i >= 1; i--) {
            const e = Math.pow(10, 3 * i);
            if (count >= e) {
        ...
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (clickCost >= e) {
                i = (clickCost / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (powerDub.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack");
    }
}
function buyInsPower() {
    if (count >= insCost) {
        (count -= insCost),
            (insCost = Math.round(80.5 * insCost)),
            (num *= 2),
            (normalIns *= 2),
            (farmerIns *= 2),
            (minerIns *= 2),
            ...
            (addantiIns *= 2),
            (addluckyIns *= 2),
            (addillusionistIns = 2 * iaddllusionistIns),
            (addcoderIns *= 2),
            (addmutiIns *= 2),
            (addspawnIns *= 2),
            (addcloneIns *= 2),
        ...
        for (let n = suffixes.length - 1; n >= 1; n--) {
            const e = Math.pow(10, 3 * n);
            if (insCost >= e) {
                i = (insCost / e).toFixed(1) + suffixes[n];
                break;
            }
        }
        (idleDub.innerHTML = " $" + i), (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack");
    }
}
let poplitSelect = !1;
function getSelected() {
    let n = document.getElementById("poplitSelectStyle"),
        i = (n.options[n.selectedIndex].text.toLowerCase(), document.getElementById("backSelectStyle"));
    i.options[i.selectedIndex].text.toLowerCase();
}
...
function research() {
    if (canRun) {
        if (((canRun = !1), 0 === functions.length)) return void console.log("Research is complete!");
        if (count >= resCost) {
            (count -= resCost), (resCost = Math.round(50.8 * resCost)), console.log(resCost);
            let n = functions.filter(function (n) {
                return !usedFunctions.includes(n);
            });
            if (0 === n.length) return void console.log("All res have already been used.");
            const i = n[Math.floor(Math.random() * n.length)];
            usedFunctions.push(i), i();
        }
        setTimeout(() => {
            canRun = !0;
        }, 5e3);
...
function resClick() {
    showUpgradesClick(), console.log("Researched click power");
}
function resIdle() {
    showUpgradeIns(), console.log("Researched idle power");
}
function showUpgradesClick() {
    ...
    for (let n = suffixes.length - 1; n >= 1; n--) {
        const e = Math.pow(10, 3 * n);
        if (resCost >= e) {
            i = (resCost / e).toFixed(1) + suffixes[n];
            break;
        }
    }
    (printerName.innerHTML = "You have $" + n), (tit.innerHTML = n + " Cats - Catstack");
    let e = 5,
        t = document.getElementById("labRes"),
        l = setInterval(function () {
            if (e <= 0) clearInterval(l), (labRes.innerHTML = "Research for $" + i), (document.getElementById("upgradesClick").style.display = "block");
            else {
                let n = Math.floor(e / 60),
                    i = e % 60;
                (t.innerHTML = "Time left: " + n + "m " + i + "s"), e--;
            }
        }, 1e3);
}
function showUpgradeIns() {
    ...
    let e = 5,
        t = document.getElementById("labRes"),
        l = setInterval(function () {
            if (e <= 0) clearInterval(l), (labRes.innerHTML = "Research for $" + i), (document.getElementById("upgradesIdle").style.display = "block");
            else {
                let n = Math.floor(e / 60),
                    i = e % 60;
                (t.innerHTML = "Time left: " + n + "m " + i + "s"), e--;
...
let usedSophie = !1,
    usedDev = !1;
function redeemcode() {
    const n = prompt("Enter code:");
    "sophie4socal" !== n || usedSophie ? ("dev" !== n || usedDev ? alert("This code has already been redeemed!") : ((usedDev = !0), resLootDev())) : ((usedSophie = !0), resLootSophie());
}
function resLootSophie() {
    alert("This code will give you 1-15 Golden Cats and 1 legendary cat. SOPHIE FOR SOCAL!!!");
    const n = Math.floor(15 * Math.random()) + 1;
    (goldencats += n), (heros += 1), alert(`You loot: \n        ${n} Golden Cats!    \n        1 Legendary: Shopie!    \n        Total goldencats: ${goldencats}     \n        Total legendarys: ${heros}`);
}
function resLootDev() {
    alert("This code will give you 50-100 Golden Cats! Go Devs!!");
    const n = Math.floor(100 * Math.random()) + 50;
    (goldencats += n), alert(`You loot: \n        ${n} Golden Cats!     \n        Total goldencats: ${goldencats}`);
}
